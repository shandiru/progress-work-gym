...
const ATHLETES = [
  {
    ...
    achievements: [
      ...
      "Arnold Classic Winner 2020",
      "IFBB Pro Card 2018",
    ],
    tags: ["Mass Building", "Contest Prep", "Powerlifting"],
    stats: [
  ...
  },
  {
    ...
    achievements: [
      "Ms. Bikini Olympia 2023",
      "Arnold Classic Europe Winner",
      "IFBB Pro Card 2019",
    ],
    tags: ["Bikini Competition", "Nutrition Coaching", "Posing"],
    stats: [
      { label: "Weight", value: "125 lbs" },
  ...
  },
  {
    ...
    achievements: [
      "World's Strongest Man Top 5",
      "Deadlift World Record 900lbs",
      "IFBB Pro Card 2017",
    ],
    tags: ["Strength Training", "Powerlifting", "Mass Gain"],
    stats: [
  ...
  },
  {
    ...
    tags: ["CrossFit", "Figure Competition", "Functional Training"],
    stats: [
  ...
  },
  {
    ...
    achievements: [
      "Classic Physique Olympia Runner-up",
      "Arnold Classic Champion",
      "IFBB Pro Card 2020",
    ],
    tags: ["Classic Physique", "Symmetry Training", "Posing Coaching"],
    stats: [
