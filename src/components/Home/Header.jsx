  ...
  return (
    <section id="home" className="relative w-full h-150 text-white overflow-hidden">
      ...
      <div className="fixed left-3 top-120 transform -translate-y-1/2 z-20 space-y-48 cursor-pointer">
        {/* SIGN UP TODAY → scrolls to #member */}
        <a
          href="#member"
          className="bg-red-600 text-white rotate-[-90deg] hover:bg-red-500 origin-left px-10 pt-2 font-bold text-lg text-center tracking-widest block"
        >
          SIGN UP TODAY
        </a>
      ...
      <div className="relative z-20 flex flex-col justify-center h-full px-4 sm:px-8 md:px-16 lg:px-24 ml-50 mt-10">
        ...
        {/* Sign Up Button → goes to #member */}
        <a
          href="#member"
          className="mt-6 max-w-40 ml-15 bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 text-sm sm:text-base tracking-wider uppercase inline-block text-center"
        >
          Sign Up
        </a>
      </div>
